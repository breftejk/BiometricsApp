...
/// <summary>
/// Sauvola's local binarization algorithm (improvement over Niblack)
/// Better for document images with varying background
/// </summary>
public static class SauvolaBinarization
{
    ...
    /// <param name="k">Threshold parameter (default: 0.5)</param>
    /// <param name="r">Dynamic range of standard deviation (default: 128)</param>
    /// <param name="windowSize">Window size for local calculation (default: 15)</param>
    public static Image Apply(Image source, double k = 0.5, double r = 128.0, int windowSize = 15)
    {
